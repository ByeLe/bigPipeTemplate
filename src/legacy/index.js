...
<head>
    ...
    <script>
        performance.mark('start_compile_dom');
    </script>
</head>
<body>
    <div class="red">
...
<script>
    const time = performance.getEntriesByName('start_compile_dom')[0];
    console.log(time.startTime);
    const loadFinish = performance.mark('load-finish');
    console.log(performance.getEntriesByName('load-finish')[0].startTime);
</script>
</html>
`;
